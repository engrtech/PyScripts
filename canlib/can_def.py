...
def proc_seed(large_frame_list, frame_count, pl_count):
    pl_count = pl_count #we dont need the 67 61
...
def proc_pw(large_frame_list, frame_count, pl_count):
    pl_count = pl_count - 3 #we dont need the 67 61
    frames_remaining = frame_count
    pl_remaining = pl_count
    payload = []
    for frame in large_frame_list:
